...
public class BaseTransUnitsTest {
    ...
    public void test_RenameAttributeTU() {
        ...
        Element body = (Element) XmlUtils.getNode(doc, "/html/body");
    ...
    public void test_RenameElementTU() {
        ...
        Element body = (Element) XmlUtils.getNode(doc, "/html/body");
        tu.visitAfter(body, null);
        assertNull("Failed to rename target element.", XmlUtils.getNode(doc, "/html/body"));
        assertNotNull("Failed to rename target element.", XmlUtils.getNode(doc, "/html/head"));
    }
    ...
    public void test_RemoveElementTU() {
        ...
        tu.visitAfter(body, null);
        assertNull("Failed to remove target element.", XmlUtils.getNode(doc, "/html/body"));
    }
    ...
    public Document parseCPResource(String classpath) {
        try {
            return XmlUtils.parseStream(getClass().getResourceAsStream(classpath), XmlUtils.VALIDATION_TYPE.NONE, true);
        } catch (Exception e) {
            e.printStackTrace();
            fail(e.getMessage());
        }
